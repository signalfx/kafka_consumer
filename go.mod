module github.com/signalfx/kafka_consumer

go 1.12

require (
	collectd.org v0.0.0-20171025113847-606bd390f38f // indirect
	...
	github.com/signalfx/golib v1.1.3
	...
	github.com/tidwall/gjson v0.0.0-20180301181557-9ed3f8e1a5d6 // indirect
	...
	gopkg.in/stack.v1 v1.5.0 // indirect
)
